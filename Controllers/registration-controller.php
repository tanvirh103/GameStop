<?php
    ...
    if(isset($_POST['submit'])){
        ...
        //Null value checking
        if(strlen(trim($fullname)) == 0 || strlen(trim($username)) == 0 || strlen(trim($phone)) == 0 || strlen(trim($email)) == 0 ||strlen(trim($role)) == 0 || strlen(trim($password)) == 0 || strlen(trim($repassword)) == 0) popup("Error!", "You can not leave any fields empty.");
