<?php
    ...
    if(isset($_POST['Update'])){
        ...
        $status = updateProduct($productid,$id,$title, $description, $category, $poster, $price, $quantity);
        
        if($status) popup("Congratulations!", "Your product info has been updated.");
        else popup("Error!", "Could not update productinfo.");
